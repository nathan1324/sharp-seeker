...
Credits per poll = number of bookmakers x number of markets (3: h2h, spreads, totals) per sport. With the default 4 bookmakers and 1 sport, each poll costs ~10-18 credits depending on API pricing.
